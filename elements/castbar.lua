...
local function CastStart(self, event, unit)
	...
	if(safeZone) then
		...
		local dimension = isHoriz and 'Width' or 'Height'
		safeZone['Set'..dimension](safeZone, element['Get'..dimension](element) * ratio)
	end
	...
	* name - the name of the cast spell (string)
	--]]
...
local function CastUpdate(self, event, unit, castID, spellID)
	...
	--[[ Callback: Castbar:PostCastUpdate(unit, name)
	...
	* name - the name of the cast spell (string)s
	--]]
